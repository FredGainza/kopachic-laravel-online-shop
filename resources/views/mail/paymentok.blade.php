  ...
  <div style="background-color:#FFFFFF;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;padding-top:28px;padding-right:25px;padding-bottom:20px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Helvetica;font-size:20px;line-height:20px;text-align:center;color:#AABBAA;"><strong>Paiement accepté</strong></div>
                    </td>
                  </tr>
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Helvetica;font-size:18px;line-height:1;text-align:left;color:#FFFFFF;">Paiement : {{ strtoupper($order->payment_text) }}</div>
                    </td>
                  </tr>
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-bottom:30px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Helvetica;font-size:18px;line-height:1;text-align:left;color:#FFFFFF;">Transaction ID : {{ $payment->payment_id }}</div>
                    </td>
                  </tr>
                </table>
              </div>
    ...
    <div style="background:#6E7783;background-color:#6E7783;margin:0px auto;max-width:600px;">
      ...
      <![endif]-->
                  ...
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;padding-top:28px;padding-right:25px;padding-bottom:20px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Helvetica;font-size:20px;line-height:20px;text-align:center;color:#AABBAA;"><strong>Détails de la commande</strong></div>
                    </td>
                  </tr>
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
      ...
      <![endif]-->
                  ...
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;padding-top:20px;padding-right:25px;padding-bottom:20px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Helvetica;font-size:15px;line-height:20px;text-align:center;color:#FFFFFF;"><a href="https://kopachic.fgainza.fr" target="_blank">KoPaTiK</a></div>
                    </td>
                  </tr>
                </table>
              </div>
