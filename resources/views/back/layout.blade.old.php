      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview {{ menuOpen(
            ...
            <a href="#" class="nav-link perso-link {{ currentRouteActive(
                'shop.edit',
                'shop.update',
                'pays.index',
                'pays.edit',
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item has-treeview {{ menuOpen('plages.edit', 'colissimos.edit') }}">
                ...
                <ul class="nav nav-treeview">
                  <x-menu-item :href="route('plages.edit')" :sub=true :active="currentRouteActive('plages.edit')">
                    Plages
                  </x-menu-item>
                  <x-menu-item :href="route('colissimos.edit')" :sub=true :active="currentRouteActive('colissimos.edit')">
                    Tarifs
                  </x-menu-item>
                </ul>
              </li>
